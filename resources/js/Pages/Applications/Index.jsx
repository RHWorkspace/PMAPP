...
export default function Index() {
    const { applications, flash } = usePage().props;
                                ...
                                <table className="min-w-full divide-y divide-gray-200">
                                    <thead>
                                        <tr>
                                            ...
                                            <th className="px-4 py-2 text-left">Project</th> {/* Ganti dari Team ke Project */}
                                    ...
                                    <tbody>
                                        {applications.length === 0 && (
                                            <tr>
                                                <td colSpan={7} className="text-center py-4">Tidak ada data application.</td>
                                            </tr>
                                        )}
                                        {applications.map((app, idx) => (
                                            <tr key={app.id} className="border-b">
                                                ...
                                                <td className="px-4 py-2">{app.project ? app.project.title : '-'}</td> {/* Ganti dari app.team ke app.project */}
