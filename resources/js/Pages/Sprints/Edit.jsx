...
export default function Edit() {
    const { sprint, teams = [] } = usePage().props;
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('sprints.update', sprint.id));
    };

    return (
        <AuthenticatedLayout
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Edit Sprint</h2>}
        >
            <Head title="Edit Sprint" />
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label className="block font-medium">Nama Sprint</label>
                                    <input
                                        type="text"
