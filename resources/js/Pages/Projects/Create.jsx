...
export default function Create() {
    const { divisions = [], teams = [] } = usePage().props;

    const { data, setData, post, processing, errors, reset } = useForm({
        title: '',
        description: '',
        status: 'Initiating', // GANTI dari 'Draft' ke 'Initiating'
        division_id: '',
        team_id: '',
        start_date: '',
        due_date: '',
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Tambah Project</h2>}
        >
